                    ...
                    <?php if ($_SESSION['user'] ?? false) : ?>
                        <div class="relative ml-3">
                            <form action="/session" method='POST'>
                                ...
                                <button class="<?= urlIs('/logout') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> ml-2 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Log Out</button>
                            </form>
                        </div>
                    <?php endif;  ?>
                </div>
